...
# ── CSS : chargé depuis le fichier bhb_style.css à la racine du repo ─────────
# Streamlit ne supporte pas <link rel="stylesheet"> externe directement,
# on récupère le CSS et on l'injecte dans un bloc <style> propre.
@st.cache_data(ttl=3600)
def load_css():
    css_url = "https://raw.githubusercontent.com/madjerad/Statsjoueurs/main/bhb_style.css"
    try:
        ...
        pass
    return ""   # fallback silencieux si le fichier n'est pas encore sur le repo

_css_content = load_css()
st.markdown(
